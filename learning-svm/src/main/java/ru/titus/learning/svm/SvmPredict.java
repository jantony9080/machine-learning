...
public class SvmPredict {
    ...
    private static String INPUT_FILE_NAME="/home/titus/Desktop/train models/bodyfat_2.txt";		// set by parse_command_line
    private static String MODEL_FILE_NAME="model.txt";		// set by parse_command_line
    private static String OUTPUT_FILE_NAME="output.txt";		// set by parse_command_line
...
//            exit_with_help();
        ...
        try
        {
            ...
            if (model == null)
            {
                System.err.print("can't open model file "+MODEL_FILE_NAME+"\n");
                System.exit(1);
            }
            if(predict_probability == 1)
            {
